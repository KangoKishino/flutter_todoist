...
// class TaskListEachTimeView extends StatelessWidget {
//   static String id = 'task_list_each_time_view';
//   const TaskListEachTimeView({
//     Key key,
//   }) : super(key: key);
...
class TaskListEachProjectView extends StatelessWidget {
  static String id = 'task_list_each_project_view';
  const TaskListEachProjectView({
    Key key,
    this.index,
  }) : super(key: key);
  final int index;
